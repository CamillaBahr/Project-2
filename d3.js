...
d3.csv("volcanos2018.csv", function(error, volcanos) {
  ...
  // Cast the number of volcanos per country
  //volcanos.forEach(function(d) {
    //d.country = +d.country;
  //});
  ...
  console.log(volcanosByCountry);

  // Configure a band scale for the horizontal axis with a padding of 0.1 (10%)
var xBandScale = d3.scaleBand()
.domain(volcanos.map(d => d.country))
.range([0, chartWidth])
.padding(0.1);

// Create a linear scale for the vertical axis.
var yLinearScale = d3.scaleLinear()
.domain([0, d3.max(volcanos, d => volcanosByCountry)])
.range([chartHeight, 0]);
